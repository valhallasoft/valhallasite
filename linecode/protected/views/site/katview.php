                        ...
                        <tr class="odd">
                            <td class="  sorting_1"  style=" padding: 10px 40px 10px 40px;"> 
                                <div class="row">
                                    ...
                                    <hr style="margin:0px;">
                                    <div class="row">
                                       created by <?php echo $Artikel['png_artikel']; ?> <span class="glyphicon glyphicon-thumbs-up" ></span> 
                                           <?php echo $Artikel['like_artikel']; ?> <span class="glyphicon glyphicon-thumbs-down" ></span> 
                                               <?php echo $Artikel['con_artikel']; ?>
                                    </div>
                                    <div class="row" >
                                        <hr style="margin:0px;">
                                <?php if($id == 3){ ?>
