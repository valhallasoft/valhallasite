        ...
        <div class="box-inner">
            <div style="display: block;" class="box-content">
                ...
                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper" role="grid">
                    ...
                    <thead>
                        <tr role="row">
                            <th aria-label="Nama  : activate to sort column ascending"  style="background: transparent" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" role="columnheader" class="sorting">Nama User</th>
                            <th aria-label="Username:  activate to sort column ascending" style="background: transparent" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" role="columnheader" class="sorting">User Name</th>
                            <th aria-label="Alamat: activate to sort column ascending" style="background: transparent" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" role="columnheader" class="sorting">Alamat </th>
                            <th aria-label="Kontak: activate to sort column ascending" style="background: transparent" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" role="columnheader" class="sorting">Kontak </th>
                            <th aria-label="Hak: activate to sort column ascending" style="background: transparent" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" role="columnheader" class="sorting">Hak </th>
                            <th aria-label="Jk: activate to sort column ascending" style="background: transparent" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" role="columnheader" class="sorting">Jenis Kelamin </th>
                            <th aria-label="aksi: activate to sort column ascending" style="background: transparent;width: 5%;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" role="columnheader" class="sorting">aksi</th>
                            </tr>
                    </thead>
                    <tbody aria-relevant="all" aria-live="polite" role="alert">
                        ...
                        <tr class="odd" > 
                            ...
                            <td class="  sorting_1" > <?php echo $User['nm_user']; ?> </td>
                            <td class="  center"> <?php echo $User['us_user']; ?> </td>
                            <td class="  center"> <?php echo $User['alt_user']; ?> </td>
                            <td class="  center"> <?php echo $User['ktk_user']; ?> </td>
                            <td class="  center"> 
                            ...
                            <td class="center ">
                            <a class="btn btn-success" href="index.php?r=admin/vusers&pk=<?php echo $User['id_user'] ?>">
