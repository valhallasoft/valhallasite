        ...
        <div class="box-inner">
            <div style="display: block;" class="box-content">
                ...
                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper" role="grid">
                    ...
                    <thead>
                        <tr role="row">
                            <th aria-label="Judul : activate to sort column descending" aria-sort="ascending" style="background: transparent" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" role="columnheader" class="sorting_asc">Judul</th>
                            <th aria-label="Tanggal: registered: activate to sort column ascending" style="background: transparent" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" role="columnheader" class="sorting">Tanggal</th>
                            <th aria-label="Pengarang: activate to sort column ascending" style="background: transparent" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" role="columnheader" class="sorting">Pengarang</th>
                            <th aria-label="like: activate to sort column ascending" style="background: transparent" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" role="columnheader" class="sorting">like</th>
                            <th aria-label="komen: activate to sort column ascending" style="background: transparent" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" role="columnheader" class="sorting">komen</th>
                            <th aria-label="aksi: activate to sort column ascending" style="background: transparent;width: 5%;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" role="columnheader" class="sorting">aksi</th></tr>
                    </thead>
                    <tbody aria-relevant="all" aria-live="polite" role="alert">
                        
                            <?php foreach($Artikels as $Artikel){ ?>
                        <tr class="odd">
                            <td class="  sorting_1"> <?php echo $Artikel['jdl_artikel']; ?> </td>
                            <td class="  center"> <?php echo $Artikel['tgl_artikel']; ?> </td>
                            <td class="  center"> <?php echo $Artikel['png_artikel']; ?> </td>
                            <td class="  center"> <?php echo $Artikel['like_artikel']; ?> </td>
                            <td class="  center"> <?php echo $Artikel['con_artikel']; ?> </td>
                            <td class="center " style="text-align: right;" >
                            <a class="btn btn-success" href="index.php?r=admin/vartikel&fitback=2&pk=<?php echo $Artikel['id_artikel'];?>">
