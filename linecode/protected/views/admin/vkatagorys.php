...
<?php $this->endWidget(); ?>
        ...
        <button onclick="myFunction1()" id='bot2' type="submit" class="btn btn-success" style="display: none;">
            <i class="glyphicon glyphicon-zoom-in icon-white"></i>
            batal Edit</button>
        <a class="btn btn-danger" href="index.php?r=admin/dartikel&pk=<?php echo $Katagory['id_katagory'] ?>"  onclick="return confirm('Are you sure you want to delete this item?');">
