        ...
        <div class="box-inner">
            <div style="display: block;" class="box-content">
                ...
                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper" role="grid">
                    ...
                    <thead>
                        <tr role="row">
                            <th aria-label="Menu : activate to sort column descending" aria-sort="ascending" style="background: transparent" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" role="columnheader" class="sorting_asc">Menu</th>
                            <th aria-label="Katagory : activate to sort column descending" aria-sort="ascending" style="background: transparent" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" role="columnheader" class="sorting_asc">Katagory</th>
                            <th aria-label="Katagory : activate to sort column descending" aria-sort="ascending" style="background: transparent" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" role="columnheader" class="sorting_asc">View</th>
                    ...
                    <tbody aria-relevant="all" aria-live="polite" role="alert">
                        ...
                        <tr class="odd">
                            ...
                            <?php foreach($Menus as $Menu ){
                                if($Menu['id_menu'] == $katagory['Menu_id_menu']){ ?>
                                    <?php echo $Menu['nm_menu'];  ?>
                                <?php break; } 
                                ?>
                             <?php }?>
                            </td>    
                            <td class="  sorting_1"> <?php echo $katagory['nm_katagory']; ?> </td>
                            <td class="  sorting_1">
                            <?php foreach($Views as $View ){
                                if($View['id_view'] == $katagory['view_id_view']){ ?>
                                    <?php echo $View['nm_view'];  ?>
                                <?php break; } 
                                ?>
                             <?php }?>
                            </td>    
                            <td class="center ">
                            <a class="btn btn-success" href="index.php?r=admin/vkatagorys&pk=<?php echo $katagory['id_katagory'] ?>">
                                <i class="glyphicon glyphicon-zoom-in icon-white"></i>
                                 View </a>
                            </a>
                            <a class="btn btn-danger" href="index.php?r=admin/dkatagorys&pk=<?php echo $katagory['id_katagory'] ?>"  onclick="return confirm('Are you sure you want to delete this item?');">
