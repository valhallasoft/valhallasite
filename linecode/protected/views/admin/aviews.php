                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li class="accordion">
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <?php 
                                foreach ($Vs as $V){ ?>
                                    <li><a href="index.php?r=admin/aartikel&id=<?php echo $V['id_view'];?>">
                                            <i class="glyphicon glyphicon-plus"></i> Artikel <?php echo $V['nm_view']; ?></a>
                                    </li>  
                          <?php }
                                ?>
                            </ul>
...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<?php echo $form->errorSummary($views); ?>

	<div class="row">
		<?php echo $form->labelEx($views,'nm_view'); ?>
		<?php echo $form->textField($views,'nm_view',array('size'=>45,'maxlength'=>45)); ?>
		<?php echo $form->error($views,'nm_view'); ?>
	</div>
