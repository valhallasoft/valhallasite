...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<?php echo $form->errorSummary($Jk); ?>

	<div class="row">
		<?php echo $form->labelEx($Jk,'Nama Jenis Kelamin'); ?>
		<?php echo $form->textField($Jk,'nm_jk',array('size'=>45,'maxlength'=>45)); ?>
		<?php echo $form->error($Jk,'nm_jk'); ?>
	</div>
