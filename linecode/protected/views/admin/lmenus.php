...
<div>
    <ul class="breadcrumb" style="margin: 0px 0px 15px 0px ;">
        ...
        <li>
            <a href="index.php?r=admin/lmenus&fitback=3">Menu</a>
        </li>
    </ul>
</div>
<div class="box-inner">
            ...
            <div style="display: block;" class="box-content">
                ...
                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper" role="grid">
                    ...
                    <tbody aria-relevant="all" aria-live="polite" role="alert">
                        ...
                        <tr class="odd">
                            <td class="  sorting_1"> <?php echo $menu['nm_menu']; ?> </td>
                            <td class="center ">
                            <a class="btn btn-danger" href="index.php?r=admin/dmenus&pk=<?php echo $menu['id_menu'] ?>"  onclick="return confirm('Are you sure you want to delete this item?');">
