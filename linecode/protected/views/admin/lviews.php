...
<div>
    <ul class="breadcrumb" style="margin: 0px 0px 15px 0px ;">
        ...
        <li>
            <a href="index.php?r=admin/lviews&fitback=3">View</a>
        </li>
    </ul>
</div>
<div class="box-inner">
        ...
        <div class="box-inner">
            <div style="display: block;" class="box-content">
                ...
                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper" role="grid">
                    ...
                    <thead>
                        <tr role="row">
                            <th aria-label="Nama : activate to sort column descending" aria-sort="ascending" style="background: transparent" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" role="columnheader" class="sorting_asc">Nama View</th>
                    ...
                    <tbody aria-relevant="all" aria-live="polite" role="alert">
                        ...
                        <tr class="odd">
                            <td class="  sorting_1"> <?php echo $View['nm_view']; ?> </td>
                            <!--
                            <td class="center " style="text-align: right;" >
                            <a class="btn btn-danger" href="index.php?r=admin/dviews&pk=<?php echo $View['id_view'] ?>"  onclick="return confirm('Are you sure you want to delete this item?');">
