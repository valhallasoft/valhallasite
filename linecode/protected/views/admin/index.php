        ...
        <div class="box-inner">
            <div style="display: block;" class="box-content">
                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper" role="grid">
                    ...
                    <thead>
                        <tr role="row">
                            <th aria-label="Username: activate to sort column descending" aria-sort="ascending" style="width: 193px;background: transparent" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" role="columnheader" class="sorting_asc">Username</th>
                            <th aria-label="Date registered: activate to sort column ascending" style="width: 162px;background: transparent" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" role="columnheader" class="sorting">Date registered</th>
                            <th aria-label="Role: activate to sort column ascending" style="width: 86px;background: transparent" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" role="columnheader" class="sorting">Role</th>
                            <th aria-label="Status: activate to sort column ascending" style="width: 86px;background: transparent" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" role="columnheader" class="sorting">Status</th>
                            <th aria-label="Actions: activate to sort column ascending" style="width: 355px;background: transparent" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" role="columnheader" class="sorting">Actions</th></tr>
                    </thead>
